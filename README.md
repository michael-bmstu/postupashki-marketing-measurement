...
Исходные продажи содержат факт оплаты, но не полный путь пользователя. Проект связывает размещение, касание, лид и заказ, чтобы рассчитывать атрибуцию и ROMI. Назначение и границы системы описаны в [разделе 1 архитектуры](agents_docs/ARCHITECTURE.md#1-назначение-и-границы).
...
Полный список допущений исходного анализа сохранён в [case study](docs/case_study.md#8-assumptions-и-как-их-проверить).
...
- [Атрибуция и ROMI](docs/attribution.md)
- [Дизайн экспериментов](docs/experiments.md)
- [Презентационный case study](docs/case_study.md)
